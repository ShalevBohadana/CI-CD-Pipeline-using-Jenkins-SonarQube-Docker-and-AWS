...
import { useConfirmPaymentMutation } from '../../../../redux/features/order/orderApi';
import { ExtendedOrder } from '@/pages/MyOrders/components/OrderItem';

interface UpComOrderProps {
  payload: ExtendedOrder;
  showImage?: boolean;
  showReviews?: boolean;
}

export const UpComOrder: React.FC<UpComOrderProps> = ({
  payload,
  showImage = false,
  showReviews = false,
}) => {
