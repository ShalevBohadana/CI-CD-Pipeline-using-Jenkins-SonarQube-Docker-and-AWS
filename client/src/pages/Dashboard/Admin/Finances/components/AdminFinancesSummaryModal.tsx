...
const { AdminFinancesSummaryModalContent: WorkWithUsSummaryModalContent } = lazilyLoadable(
  () => import('./AdminFinancesSummaryModalContent')
);

export const AdminFinancesSummaryModal = () => {
  const { isOpen, setIsOpen } = useAdminFinancesContext();
  return (
