...
const { AddNewPartnerForm: UserRegistrationModalContent } = lazilyLoadable(
  () => import('../components/AddNewPartnerForm')
);
...
export const Header = () => {
  ...
  const handleAddNewPartnerModal = () => {
    setIsModalOpen(true);
  };
    ...
    <header className='grid gap-6'>
      <div className='flex flex-wrap gap-5 items-center justify-center xl:justify-between'>
        ...
        <div className='inline-flex items-center gap-5 xl:justify-self-end'>
          ...
          <button
            onClick={handleAddNewPartnerModal}
            type='button'
            className='
