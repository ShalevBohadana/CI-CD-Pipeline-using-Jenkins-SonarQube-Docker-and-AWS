...
const { WorkWithUsSummaryModalContent } = lazilyLoadable(
  () => import('./WorkWithUsSummaryModalContent')
);

export const WorkWithUsSummaryModal = () => {
  const { isOpen, setIsOpen } = useWorkWithUsApprovalContext();
  return (
