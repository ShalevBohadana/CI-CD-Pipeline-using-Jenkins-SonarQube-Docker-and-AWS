import { useCreateGameCurrencyContext } from '.';

export const Header = () => {
  const { gameCurrencyData: currencyData } = useCreateGameCurrencyContext();
  if (currencyData) {
    console.log(currencyData);
  }

  return (
    <header className='py-10 xl:py-10 relative isolate z-50 '>
