...
const becomeCurrencySupplierZ = z.object({
...
export type BecomeCurrencySupplier = Pretty<
  z.infer<typeof becomeCurrencySupplierZ> & {
    // user: ObjectId;
    status: 'accepted' | 'rejected' | 'pending';
  }
>;
const requestForBecomingCurrencySupplierZodSchema = z.object({
  body: becomeCurrencySupplierZ,
});

export const CurrencySupplierValidation = {
  requestForBecomingCurrencySupplierZodSchema,
};
